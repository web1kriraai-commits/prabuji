        ...
        >
            ...
            <div className="relative w-full group overflow-hidden bg-gray-900 shadow-xl">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="absolute top-4 right-4 md:top-6 md:right-6 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-4 py-2 md:px-6 md:py-3 rounded-full font-bold shadow-xl flex items-center gap-2 text-sm md:text-base z-10 cursor-pointer"
                >
